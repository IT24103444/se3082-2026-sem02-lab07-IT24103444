...
int main(int argc, char **argv) {
    ...
    /* Scatter one chunk of the array to each process */
    ...
    /*
     * SCAN: Calculate the prefix sum.
     * Each process receives the sum of all local sums
     * from rank 0 up to its own rank.
     */
    ...
    /* Last rank's prefix sum should equal the global total */
    if (rank == size - 1) {
