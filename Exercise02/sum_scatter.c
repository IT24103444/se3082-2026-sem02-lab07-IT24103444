...
int main(int argc, char **argv) {
    ...
    /*
     * Every process allocates space only for its own chunk.
     */
    ...
    /*
     * SCATTER: Root divides the array and sends one chunk
     * to each process.
     */
    ...
    /*
     * Each process sums only its local chunk.
     */
    ...
    /*
     * Keep the Send/Recv collection from Exercise 1.
     */
    if (rank != 0) {
