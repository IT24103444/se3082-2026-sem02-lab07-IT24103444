...
int main(int argc, char **argv) {
    ...
    /*
     * Scatter the array so each process receives one chunk.
     */
    ...
    /*
     * Root allocates an array to receive all local sums.
     */
    ...
    /*
     * GATHER: Collect the local sum from every process
     * into all_sums on the root process.
     */
    ...
    if (rank == 0) {
        ...
        /* Root manually adds all gathered local sums */
